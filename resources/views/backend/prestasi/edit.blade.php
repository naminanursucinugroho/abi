      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('profil.edit') }}"><i class="fa fa-circle-o"></i> Profil Umum</a></li>
  ...
  <section class="content">
      <div class="row">
        <div class="col-md-12">
          ...
          <form method="delete" action="{{route('prestasi.destroy',$prestasi->id)}}" class="form-inline js-confirm" data-confirm="Apakah Anda Yakin Ingin Menghapus {{$prestasi->judul}} ?">
            <div class="box-header">
              <h3 class="box-title">Ubah Prestasi {{ $prstasi->nama }}
                <small>SMK Assalaam Bandung</small>
              </h3>
              
                <button type="submit" class="btn btn-danger pull-right"><span class="fa fa-trash"></span> Hapus Prestasi</button>
              </form>
              <hr>
            </div>
            <!-- /.box-header -->
            <div class="box-body pad">
                {!! Form::model($prestasi,['url'=>route('prestasi.update',$prestasi->id), 'method'=>'put', 'files'=>'true', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal']) !!}
                            ...
                            {!! Form::label('ruangan','Foto Ruang Praktik *',['class'=>'col-md-2 control-label']) !!}
                                ...
                                {!! Form::label('judul','Foto Judul *',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-4">
                                @if(isset($prestasi) && $prestasi->judul)
                                <p>
                                    {!! Html::image(asset('img/'.$prestasi->judul),null,['class'=>'img-rounded img-responsive']) !!}
                                </p>
                                @endif
                                    <input type="file" name="judul" class="btn btn-default btn-block" required=""></input>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::submit('Simpan prestasi', ['class'=>'btn btn-primary btn-block']) !!}
                                </div>
                            </div>
                {!! Form::close() !!}
            </div>
