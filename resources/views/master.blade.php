...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>SELAMAT DATANG DI APLIKASI SAYA ASSLAAM.co</title>
  ...
  <!-- 
	...
	<link rel="shortcut icon" href="medicio/favicon.ico">

	<link href='medicio/https://fonts.googleapis.com/css?family=Roboto:400,100,300,700,900' rel='stylesheet' type='text/css'>
	
	<!-- Animate.css -->
	<link rel="stylesheet" href="medicio/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="medicio/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="medicio/css/bootstrap.css">
	<!-- Superfish -->
	<link rel="stylesheet" href="medicio/css/superfish.css">

	<link rel="stylesheet" href="medicio/css/style.css">


	<!-- Modernizr JS -->
	<script src="medicio/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<!-- jQuery Easing -->
	<script src="medicio/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="medicio/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="medicio/js/jquery.waypoints.min.js"></script>
	<!-- Stellar -->
	<script src="medicio/js/jquery.stellar.min.js"></script>
	<!-- Superfish -->
	<script src="medicio/js/hoverIntent.js"></script>
	<script src="medicio/js/superfish.js"></script>

	<!-- Main JS (Do not remove) -->
	<script src="medicio/js/main.js"></script>
